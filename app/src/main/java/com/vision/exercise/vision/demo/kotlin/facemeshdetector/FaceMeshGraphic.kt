package com.vision.exercise.vision.demo.kotlin.facemeshdetector
 ...
 * view.
 */
class FaceMeshGraphic(overlay: com.vision.exercise.vision.demo.GraphicOverlay, private val faceMesh: FaceMesh) :
  com.vision.exercise.vision.demo.GraphicOverlay.Graphic(overlay) {
  ...
  init {
    ...
    useCase = com.vision.exercise.vision.demo.preference.PreferenceUtils.getFaceMeshUseCase(applicationContext)
