package com.vision.exercise.vision.demo.kotlin.facedetector
 ...
 */
class FaceGraphic constructor(overlay: com.vision.exercise.vision.demo.GraphicOverlay?, private val face: Face) : Graphic(overlay) {
