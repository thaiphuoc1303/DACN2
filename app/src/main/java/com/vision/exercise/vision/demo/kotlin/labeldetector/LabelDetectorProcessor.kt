package com.vision.exercise.vision.demo.kotlin.labeldetector
...
class LabelDetectorProcessor(context: Context, options: ImageLabelerOptionsBase) :
  ...
  override fun onSuccess(labels: List<ImageLabel>, graphicOverlay: com.vision.exercise.vision.demo.GraphicOverlay) {
