package com.vision.exercise.vision.demo.kotlin.barcodescanner
...
class BarcodeGraphic constructor(overlay: com.vision.exercise.vision.demo.GraphicOverlay?, private val barcode: Barcode?) :
  Graphic(overlay) {
