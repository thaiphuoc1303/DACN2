package com.vision.exercise.vision.demo.kotlin.objectdetector
...
class ObjectDetectorProcessor(context: Context, options: ObjectDetectorOptionsBase) :
  ...
  override fun onSuccess(results: List<DetectedObject>, graphicOverlay: com.vision.exercise.vision.demo.GraphicOverlay) {
